      ...
      <tbody>
        @foreach($invoice_detail as $i => $invd)
          <tr>
            ...
            <td class="action">
              <span data-toggle="modal" data-target="#invd" style="cursor: pointer;" title="Edit" class="btn btn-sm btn-success edit" data-invdid="{{$invd->id}}"><i class="fa fa-pencil-alt"></i></span>
