						...
						<div class="col-sm-6">
							<div class="col-sm-12">
								<div class="form-group {{(($errors->has('com_name'))?'has-error':'')}}">
									...
									<input class="form-control nbr" type="text" name="com_name" placeholder="name" value="{{ (count($errors) > 0) ? old('com_name') : $company->com_name }}" autocomplete="off" required />
								</div>
							</div>
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<textarea class="form-control nbr" name="com_description"  style="height: 108px;" placeholder="description">{{ (count($errors) > 0) ? old('com_description') : $company->com_description }}</textarea>
								</div>
							</div>							
						</div><!-- /.column -->
					</div><!--  /.row -->
