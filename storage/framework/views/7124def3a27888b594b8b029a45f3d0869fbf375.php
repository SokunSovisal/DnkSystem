...
<?php $__env->startSection('content'); ?>
	...
	<?php echo Form::open(['url' => route('projectprocess.update', $transaction->id)]); ?>
		...
		<section class="bg-white">
			...
			<br/>
				<div class="row">
					<div class="col-sm-6">
						<div class="col-sm-12">
							<div class="form-group has-err <?php echo e((($errors->has('tr_start_date'))?'has-error':'' )); ?>">
								<label class="control-label">ការបរិច្ឆេទ <small>*</small></label>
								<div class='input-group date'>
									<input class="form-control nbr" type="text" id='tr_start_date' name="tr_start_date" placeholder="date & time" value="<?php echo e(((count($errors) > 0) ? old('tr_start_date') : $transaction->tr_start_date)); ?>" autocomplete="off" required data-mask="9999-99-99" />
						...
						<div class="col-sm-12">
							<div class="form-group <?php echo e((($errors->has('tr_date_count'))?'has-error':'' )); ?>">
								...
								<div class='input-group date'>
									<input class="form-control" type="number" pattern="[0-9]" min="0" id='tr_date_count' value="<?php echo e($transaction->tr_date_count); ?>" name="tr_date_count" placeholder="estimate time" value="<?php echo e(((count($errors) > 0) ? old('tr_date_count') : '')); ?>" autocomplete="off" />
						...
						<div class="col-sm-12">
							<div class="form-group <?php echo e((($errors->has('tr_invoice_id'))?'has-error':'' )); ?>">
								<label class="control-label">វិក្កយត្រប័ត្រ <?php echo e($transaction->tr_company_id); ?></label>
                <select name="tr_invoice_id" class="form-control select2" id="tr_invoice_id">
                  ...
                  <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($invoice->id); ?>" <?php echo e((($invoice->id == old('tr_invoice_id') || $invoice->id == $transaction->tr_invoice_id )? 'selected':'')); ?>><?php echo e($invoice->inv_number); ?></option>
                ...
                <select name="tr_company_id" class="form-control select2" id="tr_company_id" required>
                  ...
                  <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($company->id); ?>" <?php echo e((($company->id == old('tr_company_id') || $company->id == $transaction->tr_company_id )? 'selected':'')); ?>><?php echo e($company->com_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
							</div>
						</div>
                ...
                <select name="tr_service_id" class="form-control select2" id="tr_service_id" required>
                  ...
                  <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($service->id); ?>" <?php echo e((($service->id == old('tr_service_id') || $service->id == $transaction->tr_service_id )? 'selected':'')); ?>><?php echo e($service->s_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
							</div>
						</div>
					...
					<div class="col-sm-6">
						<div class="col-sm-12">
							<div class="form-group has-err <?php echo e((($errors->has('tr_date_alert'))?'has-error':'' )); ?>">
								<label class="control-label">ការបរិច្ឆេទជូនដំណឹង <small>*</small></label>
								<div class='input-group date'>
									<input class="form-control nbr" type="text" id='tr_date_alert' name="tr_date_alert" placeholder="date & time" value="<?php echo e(((count($errors) > 0) ? old('tr_date_alert') : $transaction->tr_date_alert)); ?>" autocomplete="off" required data-mask="9999-99-99" />
								  <span class="nbr input-group-addon">
									  <span class="glyphicon glyphicon-calendar"></span>
								  </span>
								</div>
                ...
                <select name="tr_verify_by" class="form-control select2" id="tr_verify_by" required>
                  ...
                  <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($user->id); ?>" <?php echo e((($user->id == old('tr_verify_by') || $user->id == $transaction->tr_verify_by )? 'selected':'' )); ?>><?php echo e($user->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="tr_description"  style="height: 184px;" placeholder="description"><?php echo e(((count($errors) > 0) ? old('tr_description') : $transaction->tr_description)); ?></textarea>
							</div>
						</div>
					</div><!-- /.column -->
				</div><!--  /.row -->
