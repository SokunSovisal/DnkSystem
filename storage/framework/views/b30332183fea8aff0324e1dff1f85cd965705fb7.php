...
<?php $__env->startSection('content'); ?>
	...
	<?php echo Form::open(['url' => route('checklist.update', $checklist->id)]); ?>
			...
			<br/>
					...
					<div class="col-sm-6">
						<div class="col-sm-12">
							<div class="form-group has-err <?php echo e((($errors->has('ch_name'))?'has-error':'' )); ?>">
								...
								<input class="form-control nbr" type="text" name="ch_name" placeholder="document name" value="<?php echo e(((count($errors) > 0)? old('ch_name') : $checklist->ch_name)); ?>" autocomplete="off" required />
							</div>
						</div>
						<div class="col-sm-12">
                ...
                <select name="ch_service_id" class="form-control nbr select2" id="ch_service_id" required>
                  ...
                  <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($service->id); ?>" <?php echo e((($service->id==$checklist->ch_service_id)? 'selected':'')); ?> ><?php echo e($service->s_name); ?></option>
					...
					<div class="col-sm-6">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="ch_description"  style="height: 108px;" placeholder="description"><?php echo e(((count($errors) > 0) ? old('ch_description') : $checklist->ch_description)); ?></textarea>
							</div>
						</div>
					</div><!-- /.column -->
				</div><!--  /.row -->
