	...
	<section class="bg-white">
		...
		<?php $__env->startComponent('comps.btnAdd'); ?>
			<?php $__env->slot('btnAdd'); ?>
				<?php echo e(route('checklist.create')); ?>
		...
		<div class="vs-datatable">
			<table class="table table-striped table-hover" id="dataTable">
				...
				<tbody>
					<?php $__currentLoopData = $checklists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $checklist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><?php echo e($i+1); ?></td>
							<td><?php echo e($checklist->ch_name); ?></td>
							<td><?php echo e($checklist->service->s_name); ?></td>
							<td><?php echo e($checklist->ch_description); ?></td>
							<td class="action text-right">
								<a href="<?php echo e(route('checklist.edit',$checklist->id)); ?>" title="Edit" class="edit btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></a>
								<?php echo e(Form::open(['url'=>route('checklist.destroy',$checklist->id)])); ?>
