	...
	<section class="bg-white">
		...
		<?php $__env->startComponent('comps.btnAdd'); ?>
			<?php $__env->slot('btnAdd'); ?>
				<?php echo e(route('mainservices.create')); ?>
		...
		<table class="table table-striped table-hover" id="dataTable">
			...
			<tbody>
				<?php $__currentLoopData = $m_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td><?php echo e($i+1); ?></td>
					<td><?php echo e($ms->ms_name); ?></td>
					<td><?php echo e($ms->ms_description); ?></td>
					<td class="action">
						<a href="<?php echo e(route('mainservices.edit',$ms->id)); ?>" title="Edit" class="edit btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></a>
						<?php echo e(Form::open(['url'=>route('mainservices.destroy',$ms->id)])); ?>
