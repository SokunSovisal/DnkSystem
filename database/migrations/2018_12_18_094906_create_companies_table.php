...
class CreateCompaniesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            $table->string('com_cp_name', 55)->nullable();
            $table->string('com_cp_phone', 65)->nullable();
            $table->string('com_cp_email', 45)->nullable();
            $table->integer('com_cp_gender')->nullable();
            $table->text('com_cp_description')->nullable();
            $table->unsignedInteger('com_district_id')->nullable();
            $table->unsignedInteger('com_province_id')->nullable();
